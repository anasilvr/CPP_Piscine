...
[x] Develop a class template Array that contains elements of type T and that implements
...
[x] As usual, ensure everything works as expected and turn in a main.cpp file that con-
tains your tests.
